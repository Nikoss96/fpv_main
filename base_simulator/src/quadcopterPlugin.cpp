...
void DroneSimpleController::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  //load parameters
  cmd_normal_topic_ = "/p2176/quadcopter/cmd_vel";
  cmd_acc_topic_ = "/p2176/quadcopter/cmd_acc";
  target_pose_topic_ = "/p2176/quadcopter/setpoint_pose";
  takeoff_topic_ = "/p2176/quadcopter/takeoff";
  land_topic_ = "/p2176/quadcopter/land";
  reset_topic_ = "/p2176/quadcopter/reset";
  posctrl_topic_ = "/p2176/quadcopter/posctrl";
  gt_pose_topic_ = "/p2176/quadcopter/pose_raw";
  gt_vel_topic_ = "/p2176/quadcopter/vel_raw";
  gt_acc_topic_ = "/p2176/quadcopter/acc_raw";
  gt_odom_topic_ = "/p2176/quadcopter/odom_raw";
  switch_mode_topic_ = "/p2176/quadcopter/vel_mode";
  // imu_topic_ = "/p2176/quadcopter/imu";
